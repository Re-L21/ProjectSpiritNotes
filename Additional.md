...
## World story
> spirit / paranormal became a normal thing, (scientific breakthrough)

## ~~AEther core fragment~~
> ~~Part of the AEther core that contains memory, collecting these will change **==*the boss fight feels*==**~~

## Location category
> Red site - standard anomaly
> Black site - active entity (named spirit), high risk
> Dead echo zone - extreme anomaly, totally dangerous
